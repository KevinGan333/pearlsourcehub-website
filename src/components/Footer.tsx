        ...
        >
          ...
          <div className="sm:col-span-2 lg:col-span-2 lg:min-w-[280px] lg:max-w-[380px]">
            ...
            <div className="mt-4 space-y-2">
              ...
              <div className="flex items-start gap-2 text-sm text-slate-400" style={{ overflowWrap: "anywhere", wordBreak: "normal" }}>
                <span className="flex-shrink-0 mt-0.5">📍</span>
                <span className="leading-relaxed">
                  Room 309, Building 2,<br />
                  Juhan Commercial Center,<br />
                  No. 16 Tianbao Road,<br />
                  Guancheng Subdistrict,<br />
                  Guancheng District,<br />
                  Dongguan City,<br />
                  Guangdong Province
                </span>
              </div>
