    ...
    <>
      ...
      <section className="py-16 sm:py-24 bg-white">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-slate-500 mb-6">Contact us at <a href="mailto:kevin.gan@pearlsourcehub.com" className="text-amber-600 hover:text-amber-700 font-medium">kevin.gan@pearlsourcehub.com</a></p>
